...
bool TextureShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"../CGP_HW2/texture.vs", L"../CGP_HW2/texture.ps");
	if (!result)
	{
		return false;
	}
...
void TextureShaderClass::FilterChange(ID3D11Device* device, D3D11_FILTER name ,int num)
{
	HRESULT result;
	D3D11_SAMPLER_DESC samplerDesc;

	m_sampleState->GetDesc(&samplerDesc);
	samplerDesc.Filter = name;
	samplerDesc.MaxAnisotropy = num;
