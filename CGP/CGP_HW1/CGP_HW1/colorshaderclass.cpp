...
bool ColorShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"D:/Visual/CGP_HW1/CGP_HW1/color.vs", L"D:/Visual/CGP_HW1/CGP_HW1/color.ps");
...
void ColorShaderClass::Bright(ID3D11Device* device, WCHAR* name)
{
	HRESULT result;
	ID3D10Blob* pixelShaderBuffer;
	...
	result = D3DX11CompileFromFile(name, NULL, NULL, "ColorPixelShader", "ps_5_0",
		D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL, &pixelShaderBuffer, 0, NULL);
	if (FAILED(result))
	{
		return;
	}
